...
roster.controller('MainController', ['$scope', function($scope) { 
 ...
 var dropdown_clicked = false; //determine if user has clicked a team from dropdown
  ...
  $scope.gotoTeam = $('.dropdown-item').click(function(){ 
    //when user clicks team, dropdown menu item is hidden after being clicked
  ...
  //function to show dropdown menu items on a hover
  $scope.hoveron = function(){
       //if a dropdown menu was clicked, hide the dropdown menu
    ...
    //currently only have starting lineup, rest of roster in progres...
  $scope.warriors = [
    {
